...
const Pepperkakemann = forwardRef(({
  title,
  titleId: _titleId,
  active,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps, ref: Ref<SVGSVGElement>) => {
  let titleId: string | undefined = "pepperkakemann-title"
  titleId = title ? _titleId ? _titleId : "title-" + titleId : undefined;
  return <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 900" width="2em" height="2em">
    <path fill={active ? "#d09242" : "#d9b78b"}
