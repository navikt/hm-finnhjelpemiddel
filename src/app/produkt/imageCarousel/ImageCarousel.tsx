...
import ImageCarouselModal from '@/app/produkt/imageCarousel/ImageCarouselModal'
...
const ImageCarousel = ({ images }: { images: Photo[] }) => {
  ...
  return (
    <>
      <ImageCarouselModal images={images} modalIsOpen={modalIsOpen} setModalIsOpen={setModalIsOpen} />
