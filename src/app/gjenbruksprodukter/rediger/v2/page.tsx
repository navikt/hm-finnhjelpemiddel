...
import { Alert, Bleed, BodyShort, Box, HelpText, HStack, Loader, Search, VStack } from '@navikt/ds-react'
      ...
      <HStack gap="space-8">
        <HStack gap="2">
          ...
          <HelpText title="Forklaring av alternativgrupper">
            En alternativgruppe er en klynge av produkter som kan erstatte hverandre. Når et
            produkt har flere grupper med alternativer, betyr det at det finnes ulike sett av
            produkter som kan brukes som erstatninger.
          </HelpText>
        </HStack>
