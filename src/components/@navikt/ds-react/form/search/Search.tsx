import cl from 'clsx'
import React, { forwardRef, InputHTMLAttributes, useCallback, useRef, useState } from 'react'
import { MagnifyingGlassIcon, XMarkIcon } from '@navikt/aksel-icons'
import { BodyShort, ErrorMessage, Label, omit } from '@navikt/ds-react'
import { useMergeRefs } from '@navikt/ds-react/src/util/hooks/useMergeRefs'
  ...
  return (
    ...
    <div
      onKeyDown={(e) => {
        ...
        searchRef.current?.value && searchRef.current?.value !== '' && e.preventDefault()
    ...
    >
      ...
      <div className="navds-search__wrapper">
        <div className="navds-search__wrapper-inner">
          {variant === 'simple' && <MagnifyingGlassIcon aria-hidden className="navds-search__search-icon" />}
          <input
            ref={mergedRef}
