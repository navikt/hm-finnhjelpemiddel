...
export const SituationCategories: Situations = [
  {
    id: 1,
    name: 'Trenger tilrettelegging på jobb eller i utdanning',
  ...
  {
    id: 3,
    name: 'Trenger tilrettelegging av bolig eller fritid',
  ...
  {
    id: 7,
    name: 'Har vansker med å huske, planlegge og organisere',
    iconUrl: '/assets/icons/calender.svg',
  },
  {
    id: 8,
    name: 'Har vansker med bevegelse og forflytning',
    iconUrl: '/assets/icons/disability.svg',
  },
